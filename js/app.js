...
function AirportDataAdapter(datasource) {
  ...
  datasource = [
    ...
    this.new_airport_object("Charles de Gaulle Airport", "Paris", "CDG", 49.003913, 2.571763, "Paris Charles de Gaulle Airport (French: Aéroport de Paris-Charles-de-Gaulle, IATA: CDG), also known as Roissy Airport (or just Roissy in French), is one of the world's principal aviation centres, as well as France's largest airport.", "http://en.wikipedia.org/wiki/Charles_de_Gaulle_Airport", 16, ["Charles de Gaulle", "Roissy Airport", "Roissy"]),
